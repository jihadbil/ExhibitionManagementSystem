...
public partial class StatusBadgeControl : UserControl
{
    ...
    private void UpdateAppearance(string status)
    {
        ...
        var map = new Dictionary<string, (string Text, string BgKey, string FgKey)>
        {
            ...
            ["True"] = ("نشط", "SuccessLightBrush", "SuccessTextBrush"),
            ["False"] = ("معطل", "DangerLightBrush", "DangerTextBrush"),
            ...
            ["PendingReview"] = ("قيد المراجعة", "WarningLightBrush", "WarningTextBrush"),
            ["Approved"] = ("مقبول", "SuccessLightBrush", "SuccessTextBrush"),
            ["Paid"] = ("مدفوع", "SuccessLightBrush", "SuccessTextBrush"),
            ["Overdue"] = ("متأخر", "DangerLightBrush", "DangerTextBrush"),
